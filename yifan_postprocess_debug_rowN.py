...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 23 13:24:07 2022
...
def postprocess(temperature=1., numResampleLogX=1, plot=True, loaded=[], \
	...
	if plot:
		...
		plt.ylabel("Level");plt.savefig("level.pdf",bbox_inches='tight')
		...
		plt.ylim([0., 1.])
		plt.xlabel("Level")
		plt.ylabel("MH Acceptance");plt.savefig("acceptance.pdf",bbox_inches='tight')
