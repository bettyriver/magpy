...
# -*- coding: utf-8 -*-
"""
Created on Wed May 18 16:07:51 2022
...
def postprocess(path,temperature=1., numResampleLogX=1, plot=True, loaded=[], \
			cut=0., save=False, zoom_in=True, compression_bias_min=1., verbose=True,\
	...
	if len(loaded) == 0:
		levels_orig = np.atleast_2d(my_loadtxt(path+"levels.txt"))
		sample_info = np.atleast_2d(my_loadtxt(path+"sample_info.txt"))
	else:
